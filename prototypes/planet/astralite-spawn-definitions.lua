...
asteroid_functions.nauvis_ratio         = {9, 0, 0, 0, 0, 0}
asteroid_functions.vulcanus_ratio       = {9, 0, 0, 0, 0, 0}
asteroid_functions.gleba_ratio          = {9, 0, 0, 0, 0, 0}
asteroid_functions.fulgora_ratio        = {9, 0, 0, 0, 0, 0}
asteroid_functions.aquilo_ratio         = {9, 0, 0, 0, 0, 0}
asteroid_functions.system_edge_ratio    = {9, 0, 0, 0, 0, 0}

asteroid_functions.cerys_ratio          = {9, 0, 0, 0, 0, 0}
asteroid_functions.muluna_ratio         = {9, 0, 0, 0, 0, 0}
asteroid_functions.maraxsis_ratio       = {9, 0, 0, 0, 0, 0}

asteroid_functions.nauvis_chunks        = 0.01
asteroid_functions.vulcanus_chunks      = 0.002
asteroid_functions.vulcanus_medium      = 0.0015
asteroid_functions.gleba_chunks         = 0.003
asteroid_functions.gleba_medium         = 0.0015
asteroid_functions.fulgora_chunks       = 0.0025
asteroid_functions.fulgora_medium       = 0.0015
asteroid_functions.aquilo_chunks        = 0.001
asteroid_functions.aquilo_big           = 0.0015
asteroid_functions.system_edge_chunks   = 0.0005
asteroid_functions.system_edge_huge     = 0.00025
...
asteroid_functions.aquilo_solar_system_edge = {
    ...
    probability_on_range_big = {
        {position = 0.1, probability = asteroid_functions.aquilo_big * 3, angle_when_stopped = asteroid_functions.big_angle},
        {position = 0.9, probability = 0, angle_when_stopped = asteroid_functions.medium_angle}
    },
    probability_on_range_huge = {
        {position = 0.1, probability = 0, angle_when_stopped = asteroid_functions.medium_angle},
...
asteroid_functions.shattered_planet_trip = {
    ...
    type_ratios = {
        ...
        {position = 0.002, ratios = {1, 1, 3, 1, 1, 1}},
...
asteroid_functions.fulgora_cerys = {
    ...
    probability_on_range_medium = {
        {position = 0.1, probability = asteroid_functions.fulgora_medium, angle_when_stopped = asteroid_functions.medium_angle},
        {position = 0.5, probability = asteroid_functions.fulgora_medium * 0.5, angle_when_stopped = asteroid_functions.medium_angle},
...
asteroid_functions.vulcanus_maraxsis = {
    ...
    probability_on_range_medium = {
        {position = 0.1, probability = asteroid_functions.vulcanus_medium, angle_when_stopped = asteroid_functions.medium_angle},
        {position = 0.5, probability = asteroid_functions.vulcanus_medium * 0.5, angle_when_stopped = asteroid_functions.medium_angle},
        {position = 0.5, probability = asteroid_functions.maraxsis_medium * 0.5, angle_when_stopped = asteroid_functions.medium_angle},
...
asteroid_functions.spawn_definitions = function (data, planet)
    ...
    for k, asteroid_size in pairs(asteroid_sizes) do
        for k, asteroid_type in pairs(asteroid_types) do
            ...
            local asteroid_id = 0
            if asteroid_type == "astralite" then
                asteroid_id = 1
            end
